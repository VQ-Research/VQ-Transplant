...
#SBATCH --output /project/6105494/sunset/VQ-Projects/VQ-Transplant2/slurm/Transplant/ImageNet/online_vq_imagenet.out
#SBATCH --error /project/6105494/sunset/VQ-Projects/VQ-Transplant2/slurm/Transplant/ImageNet/online_vq_imagenet.err
