...
CUDA_VISIBLE_DEVICES="0" python -m torch.distributed.launch --nproc_per_node=1 --master_port=12226 train_substitution.py --VQ=wasserstein_vq --dataset_name=ImageNet --global_batch_size 64 --factor 16 --resolution 256 --codebook_size 16384  --stage=substitution --use_multiscale --gamma_1=0.1